...
#define MainColor UIColorHex(0099FF)
#define MainGrayColor UIColorHex(F2F2F5)
#define MainTextColor UIColorHex(333333)
#define MainLineColor UIColorHex(E5EAF0)
#define TextFiedlColor UIColorHex(D4D9DF)
#define SubTextColor UIColorHex(999999)
#define ConTextColor UIColorHex(EF4836)
#define StatusBarColor UIColorHex(831017)
#define NavigatorColor UIColorHex(c62626)

#define MainBackgroundColor UIColorHex(f5f5f5)
