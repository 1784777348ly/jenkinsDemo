...
- (void)setModel:(TZAssetModel *)model {
    ...
    self.selectImageView.image = self.selectPhotoButton.isSelected ? [UIImage imageNamed:@"common_iconcubecolor_check"] : [UIImage imageNamed:@"common_iconcubeline_check"];
...
- (void)setMaxImagesCount:(NSInteger)maxImagesCount {
    ...
    if (!self.selectPhotoButton.hidden) {
        self.selectPhotoButton.hidden = 0;
    }
    if (!self.selectImageView.hidden) {
        self.selectImageView.hidden = 0;
    }
}
...
- (void)selectPhotoButtonClick:(UIButton *)sender {
    ...
    self.selectImageView.image = sender.isSelected ? [UIImage imageNamed:@"common_iconcubecolor_check"] : [UIImage imageNamed:@"common_iconcubeline_check"];
...
- (UIButton *)selectPhotoButton {
    if (_selectImageView == nil) {
        ...
        selectPhotoButton.frame = CGRectMake(self.tz_width - FitValue(30), self.tz_width - FitValue(30), FitValue(30), FitValue(30));
...
- (UIImageView *)selectImageView {
    if (_selectImageView == nil) {
        ...
        selectImageView.frame = CGRectMake(self.tz_width - FitValue(30), self.tz_width - FitValue(30), FitValue(30), FitValue(30));
